...
DHCP.DI.initialize = function () {
    ...
    // Second call back function to draw the form
    function cb2(e, datum)
    {
        var file = DHCP.DI.file;
        var ien = datum.ien;
        DHCP.DI.dd(file,"0.01:999999")
    }
    
    // Call back function when we make a selection to populate the
    ...
    function cb(e, datum)
    {
        ...
        DHCP.DI.file = file;
        DHCP.DI.fileName = fn;
        DHCP.DI.typeaheadPopulate(file, '#entries', cb2)
    }
