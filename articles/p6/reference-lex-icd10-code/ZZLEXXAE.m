ZZLEXXAE ;SLC/KER - Import - ICD-10-CM - Lex IA/RA ;10/26/2017
...
IA(X,Y,Z) ; IA - Inactivate Code/Expression
 ...
 ;     Z    Source
 N ACT,CODE,CDT,CTL,DA,EXIT,I,IEN,LAS,LEXCHK,ORD,PEFF,PIEN,PSTA,SF,LEXEXP,LSTAD,TMP,SRC,CODES S ACT="IA"
 ...
 . . . D:$D(TEST) WRT^ZZLEXXAD Q:'$D(FULL)
...
RA(X,Y,Z) ; RA - Reactivate Code/Expression
 ...
 . . N DA,ERR,FDA K ERR,FDA,DA S DA=+($G(SIEN))
 . . S FDA(757.02,(DA_","),5)="" D FILE^DIE(,"FDA","ERR") D:$D(ERR) ERR^ZZLEXXAD
 . D:$D(TEST) WRT^ZZLEXXAD I $D(FULL) D
